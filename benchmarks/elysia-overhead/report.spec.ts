...
describe("benchmark reporting", () => {
  ...
  test("builds a complete benchmark comparison chart", () => {
    ...
    expect(serializedChart).toContain("Aponia vs Elysia");
    ...
    expect(serializedChart).toContain("Measured iterations");
    ...
    expect(serializedChart).not.toContain("Test CPU");
    expect(serializedChart).not.toContain("Inter");
